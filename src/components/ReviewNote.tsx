    ...
    <>
      ...
      >
        <CardHeader className="relative h-32 ">
          ...
          <div
            className="absolute  -left-1 -right-1 top-14 w-1/4 rounded-l-sm rounded-br-sm  rounded-tr-lg bg-gradient-to-r from-teal-500 to-transparent pl-6 text-sm text-white lg:w-1/3"
            style={{
